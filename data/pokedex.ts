export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	mimikyu: {
		...
		baseForme: "Disguised",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 65, atk: 90, def: 80, spa: 50, spd: 105, spe: 90},
	...
	lunaster: {
		...
		name: "Lunaster",
		types: ["Fairy", "Psychic"],
		baseStats: {hp: 40, atk: 30, def: 35, spa: 60, spd: 80, spe: 55},
		...
		evos: ["Crescelene"],
		eggGroups: ["Fairy"],
		otherFormes: ["Lunaster-Gascar", "Lunaster-Woollerico"],
		formeOrder: ["Lunaster", "Lunaster-Gascar", "Lunaster-Woollerico"],
	},
	lunastergascar: {
		num: 1000,
		name: "Lunaster-Gascar",
		baseSpecies: "Lunaster",
		forme: "Gascar",
		types: ["Poison", "Psychic"],
		baseStats: {hp: 65, atk: 70, def: 75, spa: 35, spd: 55, spe: 15},
		abilities: {0: "Cute Charm", H: "Neutralizing Gas"},
		heightm: 0.7,
		weightkg: 9.2,
		color: "Gray",
		evos: ["Crescelene-Gascar"],
		eggGroups: ["Fairy", "Mineral"],
	},
	lunasterwoollerico: {
		num: 1000,
		name: "Lunaster-Woollerico",
		baseSpecies: "Lunaster",
		forme: "Woollerico",
		types: ["Fairy", "Ghost"],
		baseStats: {hp: 60, atk: 30, def: 70, spa: 50, spd: 80, spe: 20},
		abilities: {0: "Cute Charm", H: "Mana Drain"},
		heightm: 0.7,
		weightkg: 4.1,
		color: "Red",
		evos: ["Crescelene-Woollerico"],
		eggGroups: ["Fairy", "Amorphous"],
	},
	crescelene: {
		num: 1001,
		name: "Crescelene",
		types: ["Fairy", "Psychic"],
		baseStats: {hp: 55, atk: 50, def: 60, spa: 80, spd: 100, spe: 75},
		abilities: {0: "Cute Charm", H: "Magic Guard"},
		heightm: 1.1,
		weightkg: 37.1,
		color: "Yellow",
		...
		evos: ["Usaluna"],
		eggGroups: ["Fairy"],
		otherFormes: ["Crescelene-Gascar", "Crescelene-Woollerico"],
		formeOrder: ["Crescelene", "Crescelene-Gascar", "Crescelene-Woollerico"],
	},
	crescelenegascarian: {
		num: 1001,
		name: "Crescelene-Gascar",
		baseSpecies: "Crescelene",
		forme: "Gascar",
		types: ["Poison", "Psychic"],
		baseStats: {hp: 85, atk: 80, def: 100, spa: 40, spd: 80, spe: 25},
		abilities: {0: "Cute Charm", H: "Neutralizing Gas"},
		heightm: 1.1,
		weightkg: 79.3,
		color: "Gray",
		prevo: "Lunaster-Gascar",
		evoLevel: 33,
		evos: ["Usaluna-Gascar"],
		eggGroups: ["Fairy", "Mineral"],
	},
	crescelenewoollerico: {
		num: 1001,
		name: "Crescelene-Woollerico",
		baseSpecies: "Crescelene",
		forme: "Woollerico",
		types: ["Fairy", "Ghost"],
		baseStats: {hp: 75, atk: 35, def: 100, spa: 85, spd: 100, spe: 25},
		abilities: {0: "Cute Charm", H: "Mana Drain"},
		heightm: 1.1,
		weightkg: 8.8,
		color: "Red",
		prevo: "Lunaster-Woollerico",
		evoLevel: 33,
		evos: ["Usaluna-Woollerico"],
		eggGroups: ["Fairy", "Amorphous"],
	},
	usaluna: {
		num: 1002,
		name: "Usaluna",
		types: ["Fairy", "Psychic"],
		baseStats: {hp: 100, atk: 75, def: 90, spa: 130, spd: 135, spe: 70},
		...
		evoLevel: 57,
		eggGroups: ["Fairy"],
		otherFormes: ["Usaluna-Gascar", "Usaluna-Woollerico"],
		formeOrder: ["Usaluna", "Usaluna-Gascar", "Usaluna-Woollerico"],
	},
	usalunagascar: {
		num: 1002,
		name: "Usaluna-Gascar",
		...
		forme: "Gascar",
		types: ["Poison", "Psychic"],
		baseStats: {hp: 105, atk: 120, def: 130, spa: 95, spd: 115, spe: 35},
		abilities: {0: "Cute Charm", H: "Neutralizing Gas"},
		heightm: 1.5,
		weightkg: 413.3,
		color: "Gray",
		prevo: "Crescelene-Gascar",
		evoLevel: 57,
		eggGroups: ["Fairy", "Mineral"],
	},
	usalunawoollerico: {
		num: 1000,
		name: "Usaluna-Woollerico",
		baseSpecies: "Usaluna",
		forme: "Woollerico",
		types: ["Fairy", "Ghost"],
		baseStats: {hp: 130, atk: 40, def: 130, spa: 140, spd: 135, spe: 25},
		abilities: {0: "Cute Charm", H: "Mana Drain"},
		heightm: 1.5,
		weightkg: 11.5,
		color: "Red",
		prevo: "Crescelene-Woollerico",
		evoLevel: 57,
		eggGroups: ["Fairy", "Amorphous"],
	},
	missingno: {
